...
- **Redirect routes**: `/experience`, `/service`, `/service-awards` redirect into `/about#…`; `/teaching/iub`, `/teaching/bracu`, `/teaching/bracu/cse420` redirect to `/teaching` (institution pages were removed; only `tier: 'detailed'` courses keep a page).
