...
> **Open Findings**: 70 (0 CRITICAL, 10 HIGH, 25 MEDIUM, 20 LOW, 15 INFO)

## Phase 5: Quality & Standards (Quick Wins)

Priority: Items that are easy and high-impact. Can be done in 1-2 sessions.

| # | Item | Category | Complexity | Impact |
|---|---|---|---|---|
| 5.1 | **CSP via `<meta>` tag** in layout.tsx | Security | EASY | HIGH |
| 5.2 | **Canonical URLs on all pages** (only 3/18 have them) | SEO | EASY | HIGH |
| 5.3 | **Web Vitals reporting** to GA4 via `web-vitals` library | Monitoring | EASY | HIGH |
| 5.4 | **Google Scholar meta tags** (`citation_*`) on publications | SEO | MODERATE | HIGH |
| 5.5 | **`sameAs` complete** in structured data (missing 2 profiles) | SEO | EASY | MEDIUM |
| 5.6 | **`ProfilePage` structured data** (Schema.org 2024 type) | SEO | EASY | MEDIUM |
| 5.7 | **`apple-touch-icon`** link tag in layout.tsx | PWA | EASY | MEDIUM |
| 5.8 | **aria-live route announcer** for SPA navigation | A11y | MODERATE | HIGH |
| 5.9 | **npm run analyze** script (bundle analyzer) | DX | EASY | HIGH |
| 5.10 | **Dependency audit step** in CI | Security | EASY | MEDIUM |
...
| Phase 5 (Quick Wins) | 10 | Mostly EASY | 1-2 |
