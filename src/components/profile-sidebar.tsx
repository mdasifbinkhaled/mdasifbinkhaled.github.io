  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="p-4 flex-grow group-data-[state=collapsed]:hidden">
        <h4 className="text-xs uppercase font-semibold text-sidebar-foreground/70 mb-3 tracking-wide">
          Contact & Links
        </h4>
        ...
        <div className="space-y-2">
          ...
          <Button
            ...
            size="sm"
            asChild
            className="w-full justify-start bg-sidebar-accent/20 hover:bg-sidebar-accent border-sidebar-border text-sidebar-foreground"
          >
            <a
      ...
      <div className="p-4 group-data-[state=collapsed]:hidden">
        <h4 className="text-xs uppercase font-semibold text-sidebar-foreground/70 mb-3 tracking-wide text-center">
          Follow Me
        </h4>
