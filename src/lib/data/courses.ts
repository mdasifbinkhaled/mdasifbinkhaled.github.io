...
export const coursesTaughtIUB: CourseData[] = [
  {
    ...
    institution: 'IUB',
    institutionName: 'Independent University, Bangladesh (IUB)',
    level: 'undergraduate',
    credits: 3,
    semester: 'Fall',
    year: 2023,
  ...
  },
  {
    ...
    technologies: ['Mathematical Software', 'Logic Proof Tools', 'Graph Theory Software'],
    assignments: [
  ...
  },
  {
    ...
    technologies: ['MATLAB', 'Python NumPy', 'Jupyter Notebooks', 'Mathematica'],
    assignments: [
  ...
  },
  {
    ...
    technologies: ['MIPS Assembly', 'SPIM Simulator', 'System Monitoring Tools'],
    assignments: [
...
// Filter functions
export const getCoursesByInstitution = (institution: CourseData['institution']) =>
...
export const getCoursesByStatus = (status: CourseData['status']) =>
  allCourses.filter(course => course.status === status);

export const getCoursesByYear = (year: CourseData['year']) =>
