        ...
        <Card className="max-w-3xl mx-auto shadow-lg">
          ...
          <CardContent className="space-y-4">
            <p className="text-center text-muted-foreground">
              I am actively seeking PhD opportunities in the following research
              areas:
            </p>
            <div className="grid gap-4 md:grid-cols-2">
              <div className="p-4 border rounded-lg hover:bg-muted/50 transition-colors">
                ...
                <p className="text-sm text-muted-foreground mt-2">
                  Focusing on developing transparent and trustworthy AI systems
                  for disease detection, diagnosis, and healthcare analytics.
                </p>
              </div>
              <div className="p-4 border rounded-lg hover:bg-muted/50 transition-colors">
                <h3 className="font-semibold text-primary">
                ...
                <p className="text-sm text-muted-foreground mt-2">
                  Utilizing MMAI and CV to combine imaging, clinical records,
                  and lab results for holistic diagnostics and comprehensive
                  healthcare insights.
                </p>
              </div>
            </div>
