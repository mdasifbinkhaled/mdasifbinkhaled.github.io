              ...
              <div className="flex items-start gap-4 p-4 bg-background/50 rounded-lg border border-border">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    ...
                    model predicts stroke risk or diagnoses a disease, doctors
                    and patients need to understand WHY—not just trust a black
                    box. My research ensures AI systems are transparent,
        ...
        <section id="research-areas">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              My work spans three interconnected domains, all focused on making
              AI understandable and beneficial for humanity
            </p>
          </div>
          ...
          <Card className="border-2 border-primary/30">
            ...
            <CardContent className="space-y-6">
              <div>
                ...
                <p className="text-lg">
                  {researchIdentity.currentFocus.primary}
                </p>
              </div>
